...
class KafkaProducerService {
  ...
  public static async initialize(): Promise<void> {
    // The singleton instance is automatically created and initialized
    // This method provides a static interface for initialization
    return kafkaProducer.initializeProducer();
  }
