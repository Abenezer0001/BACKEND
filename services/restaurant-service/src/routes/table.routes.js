...
// Direct table access routes (without restaurant/venue context)
router.route('/tables/:tableId')
    .get(function(req, res) { controller.getTableById(req, res); })
    .delete(function(req, res) { controller.delete(req, res); }); // Add direct table deletion endpoint
